...
/**
 * An OO implementation of Elgg's views system.
 * 
 * WARNING: THIS API IS IN TRANSITION. PLUGIN DEVS DO NOT USE.
 * 
 * @see engine/lib/views.php
 * @access private
 */
class ElggViewService {
    ...
    function viewExists($view, $viewtype = '', $recurse = true) {
        global $CONFIG;
    ...
    /**
     * @see elgg_view in engine/lib/views.php
     */
    function view($view, $vars = array(), $bypass = false, $viewtype = '') {
        global $CONFIG;
    	static $usercache;
