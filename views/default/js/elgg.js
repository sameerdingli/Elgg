...
define('elgg', function(require) {
	 ...
	 *
	 * @return boolean Whether val is undefined.
	 */
	elgg.isUndefined = function(val) {
		return elgg.typeOf(val) == 'undefined';
	};
	
	
	elgg.isDefined = function(val) {
		return !elgg.isUndefined(val);
	};
	...
	elgg.inherit = function(Child, Parent) {
		 ...
		 * @return {*} The return value of the super class method
		 */
	...
	elgg.is_in_object_array = function(object, parent, value) {
		return elgg.isArray(object[parent]) && object[parent].indexOf(value) >= 0;
	};
	...
	/**
	 * @return {String} The site's URL base.
	 */
